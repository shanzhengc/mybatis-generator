...
public class ErpJindieAsnAtemsEntity {
    /**
     * 编号 id
     */
    private Long id;
     ...
     * @mbggenerated
     */
    public ErpJindieAsnAtemsEntity(Long id, String asnNo, Long tenantId, Short line, String productsExtendid, BigDecimal qty, String warehouseNo, String batchCode, Date productTime, Date expiryTime, Short shelflifeDay, String orderItemsRemark, String ownerCode, String inventoryType, String inventoryStatus, BigDecimal caigouPrice, BigDecimal taxRate, BigDecimal caigouMoney, String sourceNo, Short sourceLine, String crePersonId, String crePerson, Date creTime, String modPersonId, String modPerson, Date modTime, Long version) {
        this.id = id;
        this.asnNo = asnNo;
     ...
     * @mbggenerated
     */
    public ErpJindieAsnAtemsEntity() {
        super();
    }
     ...
     * @author caishanzheng
     * @date 2019-05-13 17:20:39
     * @param caigouPrice 采购单价
     */
    public void setCaigouPrice(BigDecimal caigouPrice) {
        this.caigouPrice = caigouPrice;
    }
